...
var file_proto_engine_v1_execution_engine_proto_goTypes = []interface{}{
	...
	(*BlobAndProof)(nil),                                 // 20: ethereum.engine.v1.BlobAndProof
	(*BlobAndProofV2)(nil),                               // 21: ethereum.engine.v1.BlobAndProofV2
}
var file_proto_engine_v1_execution_engine_proto_depIdxs = []int32{
	16, // 0: ethereum.engine.v1.ExecutionPayloadCapella.withdrawals:type_name -> ethereum.engine.v1.Withdrawal
	16, // 1: ethereum.engine.v1.ExecutionPayloadDeneb.withdrawals:type_name -> ethereum.engine.v1.Withdrawal
	...
	17, // 4: ethereum.engine.v1.ExecutionPayloadDenebAndBlobsBundle.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundle
	3,  // 5: ethereum.engine.v1.ExecutionPayloadDenebAndBlobsBundleV2.payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	18, // 6: ethereum.engine.v1.ExecutionPayloadDenebAndBlobsBundleV2.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundleV2
	...
	17, // 8: ethereum.engine.v1.ExecutionPayloadDenebWithValueAndBlobsBundle.blobs_bundle:type_name -> ethereum.engine.v1.BlobsBundle
	16, // 9: ethereum.engine.v1.PayloadAttributesV2.withdrawals:type_name -> ethereum.engine.v1.Withdrawal
	16, // 10: ethereum.engine.v1.PayloadAttributesV3.withdrawals:type_name -> ethereum.engine.v1.Withdrawal
...
func file_proto_engine_v1_execution_engine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_engine_v1_execution_engine_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecutionPayloadDenebAndBlobsBundleV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
