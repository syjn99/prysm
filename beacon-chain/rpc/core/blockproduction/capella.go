...
func (b *BlockProducer) setBlsToExecData(blk interfaces.SignedBeaconBlock, headState state.BeaconState) {
	...
	changes, err := b.BLSChangesPool.BLSToExecChangesForInclusion(headState)
	if err != nil {
