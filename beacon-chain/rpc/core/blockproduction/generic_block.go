...
func (b *BlockProducer) constructGenericBeaconBlock(
	...
	switch sBlk.Version() {
	case version.Phase0:
		return b.constructPhase0Block(blockProto), nil
	case version.Altair:
		return b.constructAltairBlock(blockProto), nil
	case version.Bellatrix:
		return b.constructBellatrixBlock(blockProto, isBlinded, bidStr), nil
	case version.Capella:
		return b.constructCapellaBlock(blockProto, isBlinded, bidStr), nil
	case version.Deneb:
		...
		return b.constructDenebBlock(blockProto, isBlinded, bidStr, bundle), nil
	case version.Electra:
		bundle, ok := blobsBundler.(*enginev1.BlobsBundle)
		if blobsBundler != nil && !ok {
			return nil, fmt.Errorf("expected *BlobsBundler, got %T", blobsBundler)
		}
		return b.constructElectraBlock(blockProto, isBlinded, bidStr, bundle), nil
	case version.Fulu:
		bundle, ok := blobsBundler.(*enginev1.BlobsBundleV2)
		if blobsBundler != nil && !ok {
			return nil, fmt.Errorf("expected *BlobsBundleV2, got %T", blobsBundler)
		}
		return b.constructFuluBlock(blockProto, isBlinded, bidStr, bundle), nil
	default:
...
func (b *BlockProducer) constructPhase0Block(pb proto.Message) *ethpb.GenericBeaconBlock {
	return &ethpb.GenericBeaconBlock{Block: &ethpb.GenericBeaconBlock_Phase0{Phase0: pb.(*ethpb.BeaconBlock)}}
}

func (b *BlockProducer) constructAltairBlock(pb proto.Message) *ethpb.GenericBeaconBlock {
	return &ethpb.GenericBeaconBlock{Block: &ethpb.GenericBeaconBlock_Altair{Altair: pb.(*ethpb.BeaconBlockAltair)}}
}

func (b *BlockProducer) constructBellatrixBlock(pb proto.Message, isBlinded bool, payloadValue string) *ethpb.GenericBeaconBlock {
	if isBlinded {
...
func (b *BlockProducer) constructCapellaBlock(pb proto.Message, isBlinded bool, payloadValue string) *ethpb.GenericBeaconBlock {
	if isBlinded {
...
func (b *BlockProducer) constructDenebBlock(blockProto proto.Message, isBlinded bool, payloadValue string, bundle *enginev1.BlobsBundle) *ethpb.GenericBeaconBlock {
	if isBlinded {
...
func (b *BlockProducer) constructElectraBlock(blockProto proto.Message, isBlinded bool, payloadValue string, bundle *enginev1.BlobsBundle) *ethpb.GenericBeaconBlock {
	if isBlinded {
...
func (b *BlockProducer) constructFuluBlock(blockProto proto.Message, isBlinded bool, payloadValue string, bundle *enginev1.BlobsBundleV2) *ethpb.GenericBeaconBlock {
	if isBlinded {
