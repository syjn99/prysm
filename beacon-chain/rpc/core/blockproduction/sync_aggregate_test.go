...
func TestProposerSyncContributions_FilterByBlockRoot(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits[:]},
			},
			want: proposerSyncContributions{},
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], Slot: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], Slot: 1},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:]},
			},
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], Slot: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], Slot: 1},
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], Slot: 2},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], Slot: 3},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], Slot: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], Slot: 2},
...
func TestProposerSyncContributions_FilterBySubcommitteeID(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "single item, not found",
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits[:], SubcommitteeIndex: 1},
			},
			want: proposerSyncContributions{},
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], SubcommitteeIndex: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], SubcommitteeIndex: 1},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:]},
			},
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], SubcommitteeIndex: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], SubcommitteeIndex: 1},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], SubcommitteeIndex: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], SubcommitteeIndex: 2},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{BlockRoot: rootA[:], SubcommitteeIndex: 0},
				&eth.SyncCommitteeContribution{BlockRoot: rootB[:], SubcommitteeIndex: 0},
...
func TestProposerSyncContributions_Dedup(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "single item",
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits1[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits1[:]},
			},
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits2_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits2_2[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits2_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits2_1[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits3[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits3[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_5[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits4_2[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_5[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits5_2[:]},
		...
		},
		{
			name: "all equal",
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits6[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits6[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits6[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits6[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits6[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_5[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_5[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits7_1[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_5[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_6[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_4[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits8_2[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_4[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits9_2[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_4[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_5[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits10_5[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits11_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits11_2[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits11_3[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits11_4[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits11_4[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits11_3[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_1[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_2[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_1[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits12_3[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_4[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits12_3[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits12_5[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits12_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits12_5[:]},
		...
		},
		{
			...
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits13_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits13_2[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits13_1[:]},
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits13_2[:]},
			},
			want: proposerSyncContributions{
				&eth.SyncCommitteeContribution{SubcommitteeIndex: 1, AggregationBits: aggBits13_2[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits13_2[:]},
...
func TestProposerSyncContributions_MostProfitable(t *testing.T) {
	...
	tests := []struct {
		name string
		cs   proposerSyncContributions
		want *eth.SyncCommitteeContribution
	}{
		{
			name: "Same item",
			cs: proposerSyncContributions{
			...
			want: &eth.SyncCommitteeContribution{AggregationBits: aggBits1[:]},
		},
		{
			...
			want: &eth.SyncCommitteeContribution{AggregationBits: aggBits2_1[:]},
		},
		{
			name: "most profitable at the start",
			cs: proposerSyncContributions{
				&eth.SyncCommitteeContribution{AggregationBits: aggBits3_1[:]},
				&eth.SyncCommitteeContribution{AggregationBits: aggBits3_2[:]},
			},
			want: &eth.SyncCommitteeContribution{AggregationBits: aggBits3_1[:]},
		},
		{
			...
			want: &eth.SyncCommitteeContribution{AggregationBits: aggBits4_2[:]},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
